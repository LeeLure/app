<template>
	...
	<view>
		<view class="box">
			<view class="head">
				<view class="headleft" @tap="revert"><image src="@/static/home/myfanhui.png" class="headimg"></image></view>
				<view class="headright"><image src="@/static/home/dian.png" class="headimg"></image></view>
			</view>
...
import { otherHomepage, homeList } from '@/config/home.js';
