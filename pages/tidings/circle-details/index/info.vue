<template>
	<view class="category-info">
		...
		<view class="info">
			...
			<template v-else>
				<view class="info-details">
					<view class="lable" @tap="toReport">举报</view>
					<view class="value"><u-icon name="arrow-right" color="rgba(255,255,255,0.5)" size="26rpx"></u-icon></view>
				</view>
			</template>
			<view class="info-details">
...
export default {
	...
	methods: {
		...
		toReport() {
			uni.navigateTo({
				url: '/pages/tidings/circle-details/report/report'
			});
		}
	}
};
