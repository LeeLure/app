<template>
	<view >
		...
		<view class="box" v-for="(item,index) in patterns" :key="index">
			<view>			
			<view class="boxtop" >
				<view class="picture">
					<image :src="item.imgUrl.img1" mode="aspectFill" class="aspectFillimg"></image>				
					
				</view>
				<view class="photograph">
					<view class="photographtop">
						<image :src="item.imgUrl.img2" mode="aspectFill" class="aspectFillimg"></image>
						
					</view>
					<view class="photographbottom">
						<image :src="item.imgUrl.img3" mode="aspectFill" class="aspectFillimg"></image>
			...
			<view class="boxbottom">
				...
				<view class="details">
					<view class="detailstop">
						<text class="detailstext1">{{item.name}}</text>
